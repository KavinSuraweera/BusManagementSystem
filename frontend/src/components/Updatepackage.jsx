...
import '../CSS/App.css';
    ...
    function Updatepackage(props) {
        ...
        function editPackage(e){
            ...
            axios.put(`http://localhost:8000/package/update/${props.match.params.id}`, updatePackage)
            .then(res =>{
        ...
        <div className="container" key="index">
            ...
            <form className="row g-3">
                <div className="col-md-6">
                    <label htmlFor="packageName" className="form-label" value="">Package Name</label>
                ...
                <div>
                    <button type="submit" className="btn btn-primary" href="/home" onClick={editPackage}>Submit</button>
                </div>
                </form>  
